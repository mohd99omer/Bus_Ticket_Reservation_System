...
public class Book_Seat2 implements Runnable{
    ...
    int Tk_id;
    public static boolean ticketbooked = false;
    ...
    public void run() {
        ...
        if (Available2[index] == true){

            System.out.println("YOUR TOTAL FARE WILL BE 2000 RUPEES ...");
    ...
    public void Display_Ticket2(int Tk_id){

            try{
                if (Tk_id == Ticket_Id && ticketbooked){
