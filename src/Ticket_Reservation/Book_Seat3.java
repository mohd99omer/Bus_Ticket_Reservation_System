...
public class Book_Seat3 implements Runnable{
    ...
    public void run() {
        ...
        if (Available3[index] == true){

            System.out.println("YOUR TOTAL FARE WILL BE 1500 RUPEES ...");
    ...
    public void Display_Ticket3(int Tk_id){
